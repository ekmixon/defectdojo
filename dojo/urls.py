...
from dojo.api import (
    UserResource,
    ProductResource,
    EngagementResource,
    TestResource,
    FindingResource,
    ScanSettingsResource,
    ScanResource,
    StubFindingResource,
    FindingTemplateResource,
    ImportScanResource,
    ...
    EndpointResource,
    JIRA_IssueResource,
    ToolProductSettingsResource,
    Tool_ConfigurationResource,
    Tool_TypeResource,
    LanguagesResource,
    LanguageTypeResource,
    App_AnalysisResource,
    BuildDetails,
...
urlpatterns = [
    ...
    # api doc urls
    url(
        r"%sapi/v1/doc/" % get_system_setting("url_prefix"),
