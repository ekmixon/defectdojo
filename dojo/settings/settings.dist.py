...
env = environ.Env(
    ...
    DD_SOCIAL_AUTH_OKTA_OAUTH2_API_URL=(
        str, "https://{your-org-url}/oauth2/default"),
)
...
if os.path.isfile(
        root("dojo/settings/.env.prod")) or "DD_ENV_PATH" in os.environ:
...
PORT_SCAN_EXTERNAL_UNIT_EMAIL_LIST = env(
...
EMAIL_CONFIG = env.email_url("DD_EMAIL_URL",
