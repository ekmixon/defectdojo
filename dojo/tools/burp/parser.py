...
def get_item(item_node, test):
    ...
    for event in item_node.findall("./collaboratorEvent"):
        ...
        if collab_details[0] == "DNS":
            ...
            collab_text = ("The Collaborator server received a " +
                           collab_details[0] + " lookup of type " +
                           collab_details[3] + " for the domain name " +
        ...
        if collab_details[0] == "HTTP":
            collab_text = ("The Collaborator server received an " +
                           collab_details[0] + " request at " +
                           collab_details[2] + " originating from " +
                           collab_details[1] + " .")
