    ...
    def __init__(self, filename, test):
        ...
        for row in csvarray:
            ...
            finding.severity_justification = (
                ...
                if row["CriticalityJustification"][0] != "'" else
                row["CriticalityJustification"][1:])
