...
urlpatterns = [
    ...
    url(r"^finding/(?P<fid>\d+)/mktemplate$",
        views.mktemplate,
        name="mktemplate"),
    url(
    ...
    url(r"^finding/(?P<fid>\d+)/open",
        views.reopen_finding,
        name="reopen_finding"),
    url(
    ...
    url(r"^template/export$",
        views.export_templates_to_json,
