    ...
    def form_args(self, bundle):
        ...
        for name, rel_field in list(rsc.fields.items()):
            ...
            if name in data and data[name] is not None:
                resource_uri = (data[name] if rel_field.full is False else
...
class MultipartResource(object):
    def deserialize(self, request, data, format=None):
        ...
        return super(MultipartResource,
...
class UserScanSettingsAuthorization(Authorization):
    ...
    def update_list(self, object_list, bundle):
        ...
        # Since they may not all be saved, iterate over them.
        for obj in object_list:
            if (bundle.request.user.is_staff or bundle.request.user
                    in bundle.obj.product.authorized_users):
                allowed.append(obj)
...
class UserScanAuthorization(Authorization):
    ...
    def read_detail(self, object_list, bundle):
        # Is the requested object owned by the user?
        return (bundle.request.user.is_staff or bundle.request.user
...
class ProductTypeResource(BaseModelResource):
    class Meta:
        ...
        @property
        def validation(self):
            return ModelFormValidation(form_class=Product_TypeForm,
...
class ProductResource(BaseModelResource):
    class Meta:
        ...
        @property
        def validation(self):
            return ModelFormValidation(form_class=ProductForm,
...
class Tool_TypeResource(BaseModelResource):
    class Meta:
        ...
        @property
        def validation(self):
            return ModelFormValidation(form_class=ToolTypeForm,
                                       resource=Tool_TypeResource)
...
class Tool_ConfigurationResource(BaseModelResource):
    ...
    tool_type = fields.ForeignKey(Tool_TypeResource,
                                  "tool_type",
                                  full=False,
                                  null=False)
    ...
    class Meta:
        ...
        @property
        def validation(self):
            return ModelFormValidation(form_class=ToolConfigForm,
                                       resource=Tool_ConfigurationResource)
...
class EngagementResource(BaseModelResource):
    ...
    build_server = fields.ForeignKey(Tool_ConfigurationResource,
                                     "build_server",
                                     full=False,
                                     null=True)
    orchestration_engine = fields.ForeignKey(Tool_ConfigurationResource,
    ...
    class Meta:
        ...
        @property
        def validation(self):
            return ModelFormValidation(form_class=EngForm,
...
class App_AnalysisResource(BaseModelResource):
    ...
    class Meta:
        ...
        @property
        def validation(self):
            return ModelFormValidation(form_class=App_AnalysisTypeForm,
                                       resource=App_AnalysisResource)
...
class LanguageTypeResource(BaseModelResource):
    class Meta:
        ...
        @property
        def validation(self):
            return ModelFormValidation(form_class=Languages_TypeTypeForm,
                                       resource=LanguageTypeResource)
...
class LanguagesResource(BaseModelResource):
    ...
    language_type = fields.ForeignKey(LanguageTypeResource,
                                      "language",
                                      full=False,
                                      null=False)
    ...
    class Meta:
        ...
        @property
        def validation(self):
            return ModelFormValidation(form_class=LanguagesTypeForm,
...
class ToolProductSettingsResource(BaseModelResource):
    ...
    product = fields.ForeignKey(ProductResource,
                                ...
                                full=False,
                                null=False)
    tool_configuration = fields.ForeignKey(Tool_ConfigurationResource,
                                           "tool_configuration",
                                           full=False,
                                           null=False)
    ...
    class Meta:
        ...
        @property
        def validation(self):
            return ModelFormValidation(form_class=ToolProductSettingsForm,
                                       resource=ToolProductSettingsResource)
...
class EndpointResource(BaseModelResource):
    ...
    class Meta:
        ...
        @property
        def validation(self):
            return ModelFormValidation(form_class=EditEndpointForm,
...
class JIRA_IssueResource(BaseModelResource):
    class Meta:
        ...
        @property
        def validation(self):
            return ModelFormValidation(form_class=JIRA_IssueForm,
                                       resource=JIRA_IssueResource)
...
class JIRA_ConfResource(BaseModelResource):
    class Meta:
        ...
        @property
        def validation(self):
            return ModelFormValidation(form_class=JIRAForm,
                                       resource=JIRA_ConfResource)
...
class JiraResource(BaseModelResource):
    ...
    class Meta:
        ...
        @property
        def validation(self):
            return ModelFormValidation(form_class=JIRA_PKeyForm,
...
class TestTypeResource(BaseModelResource):
    class Meta:
        ...
        @property
        def validation(self):
            return ModelFormValidation(form_class=Test_TypeForm,
...
class TestResource(BaseModelResource):
    ...
    class Meta:
        ...
        @property
        def validation(self):
            return ModelFormValidation(form_class=TestForm,
...
class FindingResource(BaseModelResource):
    ...
    def dehydrate(self, bundle):
        ...
        bundle.data[
            "product"] = "/api/v1/products/%s/" % engagement[0].product.id
        return bundle
...
class FindingTemplateResource(BaseModelResource):
    ...
    """
        ...
        @property
        def validation(self):
            return ModelFormValidation(form_class=FindingTemplateForm,
                                       resource=FindingTemplateResource)
...
class StubFindingResource(BaseModelResource):
    ...
    class Meta:
        ...
        @property
        def validation(self):
            return ModelFormValidation(form_class=StubFindingForm,
                                       resource=StubFindingResource)
...
class ScanSettingsResource(BaseModelResource):
    ...
    class Meta:
        ...
        @property
        def validation(self):
            return ModelFormValidation(form_class=ScanSettingsForm,
                                       resource=ScanSettingsResource)
...
class ImportScanValidation(Validation):
    def is_valid(self, bundle, request=None):
        ...
        if "file" not in bundle.data:
            errors.setdefault(
                "file", []).append("You must pass a file in to be imported")
        ...
        if "engagement" not in bundle.data:
            errors.setdefault("engagement",
                              []).append("engagement must be given")
        else:
        ...
        if "scan_type" in bundle.data:
            if bundle.data["scan_type"] not in scan_type_list:
                errors.setdefault(
                    "scan_type",
                    []).append("scan_type must be one of the following: " +
                               ", ".join(scan_type_list))
        else:
        ...
        if "active" in bundle.data:
            ...
            if not isinstance(bundle.data["active"], bool):
                errors.setdefault("active",
                                  []).append("active must be a boolean")
        if "verified" in bundle.data:
            ...
            if not isinstance(bundle.data["verified"], bool):
                errors.setdefault("verified",
                                  []).append("verified must be a boolean")
    ...
    def hydrate(self, bundle):
        bundle.obj.__setattr__(
            ...
            Engagement.objects.get(
                id=get_pk_from_uri(bundle.data["engagement"])),
        )
    ...
    def obj_create(self, bundle, **kwargs):
        ...
        try:
            for item in parser.items:
                ...
                if hasattr(
                        item,
                        "unsaved_req_resp") and len(item.unsaved_req_resp) > 0:
...
class ReImportScanResource(MultipartResource, Resource):
    ...
    def obj_create(self, bundle, **kwargs):
        ...
        try:
            parser = import_parser_factory(bundle.data["file"], test, active,
                                           verified, scan_type)
        except ValueError:
            raise NotFound("Parser ValueError")
        ...
        try:
            ...
            for finding_id in to_mitigate:
                ...
                finding.mitigated = datetime.combine(scan_date,
                                                     timezone.now().time())
