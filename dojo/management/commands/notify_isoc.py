...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        msg = "\nGreetings, \n\n"
        msg += get_system_setting(
            "team_name") + " will be performing port scans of "
        ...
        for s in scSettings:
            msg += "\n\nProduct: " + str(
                Product.objects.get(id=s.product_id).name)
        ...
        send_mail(
            get_system_setting("team_name") + " Port Scan",
            msg,
