...
class EngagementTest(unittest.TestCase):
    ...
    def test_add_new_engagement(self):
        ...
        driver.find_element_by_id("id_name").send_keys(
            "\tthis is engagement test.")
        driver.find_element_by_id("id_test_strategy").clear()
        driver.find_element_by_id("id_test_strategy").send_keys(
            "http://localhost:5000")
        ...
        self.assertTrue(
            re.search(r"Engagement added successfully.", EngagementTXT))
    ...
    def test_edit_created_new_engagement(self):
        ...
        driver.find_element_by_id("id_name").send_keys(
            "edited test engagement")
        Select(driver.find_element_by_id("id_status")).select_by_visible_text(
            "In Progress")
        driver.find_element_by_css_selector("input[value='Done']").click()
        EngagementTXT = driver.find_element_by_tag_name("BODY").text
        self.assertTrue(
            re.search(r"Engagement updated successfully.", EngagementTXT))
    ...
    def test_engagement_import_scan_result(self):
        ...
        Select(driver.find_element_by_id(
            "id_scan_type")).select_by_visible_text("Nmap Scan")
        ...
        self.assertTrue(
            re.search(
                r"Nmap Scan processed, a total of 13 findings were processed",
                EngagementTXT,
            ))
    ...
    def test_close_new_engagement(self):
        ...
        EngagementTXT = driver.find_element_by_tag_name("BODY").text
        self.assertTrue(
            re.search(r"Engagement closed successfully.", EngagementTXT))
    ...
    def test_delete_new_closed_engagement(self):
        ...
        EngagementTXT = driver.find_element_by_tag_name("BODY").text
        self.assertTrue(
            re.search(r"Engagement and relationships removed.", EngagementTXT))
    ...
    def test_new_ci_cd_engagement(self):
        ...
        driver.find_element_by_xpath(
            "//a[@class='dropdown-toggle active']//span[@class='hidden-xs']"
        ).click()
        driver.find_element_by_link_text("Add New CI/CD Engagement").click()
        driver.find_element_by_id("id_name").send_keys(
            "test new ci/cd engagement")
        driver.find_element_by_id("id_name").send_keys(
            "\ttest new ci/cd engagement")
        driver.find_element_by_id(
            "id_deduplication_on_engagement").get_attribute("checked")
        driver.find_element_by_css_selector("input[value='Done']").click()
        EngagementTXT = driver.find_element_by_tag_name("BODY").text
        self.assertTrue(
            re.search(r"Engagement added successfully.", EngagementTXT))
