...
class ProductTest(unittest.TestCase):
    ...
    def test_create_product_type(self):
        ...
        self.assertTrue(
            re.search(r"Product type added successfully.", productTxt))
    ...
    def test_edit_product_type(self):
        ...
        driver.find_element_by_id("id_name").send_keys(
            "Edited product test type")
        driver.find_element_by_css_selector("input.btn.btn-primary").click()
        productTxt = driver.find_element_by_tag_name("BODY").text
        self.assertTrue(
            re.search(r"Product type updated successfully.", productTxt))
    ...
    def test_delete_product_type(self):
        ...
        productTxt = driver.find_element_by_tag_name("BODY").text
        self.assertTrue(
            re.search(r"Product type Deleted successfully.", productTxt))
